...
Sarah joined the Fay Lab in the Fall of 2024. She grew up in New Bedford, Massachusetts and completed her undergraduate studies in Writing and Journalism at Emerson College. When she decided to pursue her longtime passion for science, she started her journey at the University of Massachusetts, Amherst and earned a M.S. in Sustainability Science, specializing in climate impacts. She is now pursuing a PhD in Marine Science at SMAST, while combining her interdisciplinary background with a quantitative approach to fisheries. Her current research is focused on the intersection of supply chain and ecosystem dynamics, and how they can be used to inform sustainable management decisions and increase access to local seafood in New England.
...
::::: grid
::: {.g-col-12 .g-col-md-4}
![](images/team/rowan-ignatius.png)
:::
...
Rowan is a Master’s Candidate in Data Science at UMassD who joined the Fay Lab this Fall 2025. He grew up in the coastal city of Chennai, India, and after undergrad spent over five years working in industry, first as a Database Administrator at BICS managing SQL databases and managing ERP tools, and later as a Technical Solution Engineer at Zoho Corporation optimizing large scale databases and automation scripts. During his graduate studies at UMass Dartmouth, Rowan has focused on building end-to-end data systems, including a production-ready IoT pipeline for real-time sensor monitoring, and a federated database system that integrates healthcare and insurance data across SQL Server and Neo4j platforms. He's particularly drawn to problems involving privacy-preserving machine learning and distributed systems, which led him to explore federated learning frameworks and explainable AI techniques for complex data patterns. Before joining the Lab, his research focused on adaptive partitioning for AI workload streaming platforms like Kafka and Kinesis. Now, Rowan is excited to bring his experience and skills into fisheries research, especially working on machine learning surrogate models to help speed up Biological reference point calculations.
:::
:::::
::::::
...
Mary Kate is a PhD student and joined the Fay Lab in Fall of 2026. Raised in New York and New Hampshire, she earned her Master's degree from the University of New Hampshire. Since 2023, Mary Kate has worked as a contracted Fisheries Biologist for the Northeast Fisheries Science Center's Cooperative Research Branch. In this role, she partners closely with the commercial squid fishing fleets and processors to collect oceanographic and biological data on longfin and shortfin squid. Her research will focus on combining cooperative research and remote sensing datasets to identify the drivers of shortfin squid life history.
:::
:::::
::::::
...
Olivia is currently an undergraduate student at UMass Dartmouth pursuing a bachelor's degree in conservation biology. While providing assistance in multiple labs throughout her 2026 Spring semester, she will also be rehabbing a range of animals, from squirrels to skunks to owls, on the weekend at the nonprofit organization Return2Wild. Olivia also takes care of 9 birds of her own, and for her future hopes to work more closely alongside wildlife in a conservation manner. In the lab, Olivia has been working to conduct video analysis of fish biodiversity and abundance in Indonesian mangroves.
:::
:::::
::::::
...
**Luca McGinnis**\
M.S. 2025\
Next/Now: *Research Biologist, Commercial Fisheries Research Foundation*\

Luca's M.S. research was focused on improving the use of fishery dependent data in Northeast US fishery stock assessments, specifically through spatially explicit catch per unit effort (CPUE) standardization for US Atlantic cod. During their graduate degree, they contributed to the 2023 Atlantic cod research track assessments.  
:::
:::::
::::::
...
::: {.g-col-12 .g-col-md-8}
**Vraj Patel**\
undergraduate student intern, 2025\

Vraj was a Courage Builder intern working in the lab for the fall 2025 semester. He is an undergraduate at UMass Dartmouth studying computer science. An international student from India, Vraj worked on improving the computational efficiency of simulation code in SSEEP, to enable more rapid implementation of varying scenarios for modeling survey effort and species distribution change.
:::
:::::
::::::
